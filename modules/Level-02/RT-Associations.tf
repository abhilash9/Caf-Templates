...
resource "azurerm_subnet_route_table_association" "subnetRTAssociation" {
    ...
    route_table_id              = each.value.rt_rg_name == data.azurerm_route_table.routeTableData[each.value.subnet_name].resource_group_name ? data.azurerm_route_table.routeTableData[each.value.subnet_name].id : null
}
